...
<FRAMESET frameSpacing=0 rows=80,* frameBorder=0>
		...
		<FRAMESET frameSpacing=0 frameBorder=0 cols=220,*>
			<FRAME name=menu src="<c:url value='/index/YHManagerMenu.html'/>" frameBorder=0 noResize scrolling=no>
			<FRAME name=dmMain src="<c:url value='/index/manager_Main.jsp'/>" frameBorder=0>
		</FRAMESET>
		<NOFRAMES>
			<p>
