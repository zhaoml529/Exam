...
<html>
  ...
  <body>
	...
	<br />
	<form action="<c:url value='/usermanager/saveAge' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">添加范围</td>
			</tr>
			<tr>
				<td>范围名称</td>
				<td>
					<input type="text" name="age_range"  emptyInfo="请填写状态名称"  size="40" />
				</td>
			</tr>
			<tr>
				<td>范围描述</td>
				<td>
					<input type="text" name="age_remark" emptyInfo="请填写状态描述" size="40"/>
				</td>
			</tr>
			<tr>
