...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：添加年龄范围</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/usermanager/saveEduction' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">添加学历</td>
			</tr>
			<tr>
				<td>学历名称</td>
				<td>
					<input type="text" name="eduBackGround_name"  emptyInfo="请填写学历名称"  size="40" />
				</td>
			</tr>
			<tr>
				<td>学历描述</td>
				<td>
					<input type="text" name="eduBackGround_remark" emptyInfo="请填写学历描述" size="40"/>
				</td>
			</tr>
			<tr>
