...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：修改学历</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/usermanager/updateEduction' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">修改学历</td>
			</tr>
			<tr>
				<td>学历名称</td>
				<td>
					<input type="text" name="eduBackGround_name" size="40" value="${edubackground.eduBackGround_name }" />
				</td>
			</tr>
			<tr>
				<td>学历描述</td>
				<td>
					<input type="text" name="eduBackGround_remark" size="40" value="${edubackground.eduBackGround_remark }" />
				</td>
			</tr>
			<tr>
		...
		<input type="hidden" name="eduBackGround_id" value="${edubackground.eduBackGround_id }"/>
	</form>
</body>
</html>
