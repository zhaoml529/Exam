...
<html>
  <head>
    ...
    <title>My JSP 'update_subject.jsp' starting page</title>
  ...
  <body>
    <table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：课程管理&nbsp;-&gt;科目设置&nbsp;-&gt;修改科目信息</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<form action="<c:url value='/courseAction/updateSubject' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			...
			<tr>
				<td>科目名称</td>
				<td>
					<input type="text" name="subject_name" size="40" value="${subject.subject_name }" />
				</td>                                                     
			</tr>
			<tr>
				<td>所属院系</td>
		...
		<select id="professional" name="professionInformation.profession_id" onchange="changeProfessional('<c:url value='/courseAction/getSubjectById'/>',this.value)" emptyInfo="请选择专业" disabled="disabled" style="width:150px;">
			...
			<tr>
				<td>科目说明</td>
				<td>
					<input type="text" name="subject_remark" size="40" value="${subject.subject_remark == null?'无':subject.subject_remark}" />
				</td>
			</tr>
			<tr>
