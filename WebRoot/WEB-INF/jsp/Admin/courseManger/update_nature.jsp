...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：修改考试状态</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/courseAction/updateExamNature' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			...
			<tr>
				<td>状态名称</td>
				<td>
					<input type="text" name="nature_name" size="40" value="${examnature.nature_name }" />
				</td>
			</tr>
			<tr>
				<td>状态描述</td>
				<td>
					<input type="text" name="nature_remark" size="40" value="${examnature.nature_remark }" />
				</td>
			</tr>
			<tr>
		...
		<input type="hidden" name="nature_id" value="${examnature.nature_id }"/>
	</form>
</body>
</html>
