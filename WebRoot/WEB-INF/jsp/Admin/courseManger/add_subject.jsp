...
<html>
  <head>
    ...
    <title>My JSP 'add_subject.jsp' starting page</title>
  ...
  <body>
    <table cellSpacing=0 cellPadding=5 style="" width="100%" border=0 style=" margin-top:0px">
        <tr>
          <td class="manageHead">当前位置：课程管理&nbsp;-&gt;科目设置&nbsp;-&gt;添加科目</td>
        </tr>
        <tr>
          <td height=2></td>
        </tr>
	...
	<form action="<c:url value='/courseAction/saveSubject'/>" method="post" onsubmit="return validateForm(this)" >
		<table class="default" align="center" width="600px">
		<tr class="title">
			<td colspan="5">&nbsp;添加科目信息</td>
		</tr>
		<tr>
			<td>科目名称</td>
				<td>
					<input type="text" name="subject_name"  emptyInfo="请填写科目名称"  size="40" />
				</td>
			</tr>
	 	<tr>
	 	...
	 	<tr>
	 	<td><span class="note"> * </span>科目说明</td>
	 	<td>
	 	<textarea name="subject_remark" size="50" maxLength="100" lengthInfo="最大长度不能超过100！" style="width:270px;height:100px" ></textarea>
	 	</td>
	 	</tr>
	 	<tr align="center">
	 	<td colspan="2"><input type="submit" value="添加科目" class="btn"></td>
	 	</tr>
	</table>
	</form>
  </body>
