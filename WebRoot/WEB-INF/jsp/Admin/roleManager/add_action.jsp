...
<html>
  ...
  <body>
  	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0 style=" margin-top:0px">
	        <tr>
	          <td class="manageHead">当前位置：权限管理&nbsp;-&gt;添加功能</td>
	        </tr>
	        <tr>
	        <td height=2></td></tr>
	</table>
    ...
    <div align="center" >
		<form action="<c:url value='/right/saveAction'/>" method="post" onsubmit="return validateForm(this);">
			<table align="center" class="default" width="300px">
				<tr class="title">
					<td colspan="2">添加功能</td>
				</tr>
				<tr>
					<td>功能名称</td>
					<td><input type="text" name="action_name" emptyInfo="请填写功能名称" size="40" />
					</td>
				</tr>
				<tr>
					<td>功能描述</td>
					<td><input type="text" name="action_remark" emptyInfo="请填写功能描述" size="40" />
					</td>
				</tr>
				<tr>
