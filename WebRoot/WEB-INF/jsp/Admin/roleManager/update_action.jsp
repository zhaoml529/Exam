...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：修改功能</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/right/updateAction' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">修改功能</td>
			</tr>
			<tr>
				<td>功能名称</td>
				<td>
					<input type="text" name="action_name" size="40" value="${action.action_name }" />
				</td>
			</tr>
			<tr>
				<td>功能描述</td>
				<td>
					<input type="text" name="action_remark" size="40" value="${action.action_remark }" />
				</td>
			</tr>
			<tr>
