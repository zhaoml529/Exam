...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：修改机构</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/department/updateDepartment' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">修改机构</td>
			</tr>
			<tr>
				<td>机构名称</td>
				<td>
					<input type="text" name="department_name" size="40" value="${departmentInformation.department_name }" />
				</td>
			</tr>
			<tr>
				<td>机构描述</td>
				<td>
					<input type="text" name="department_remark" size="40" value="${departmentInformation.department_remark }" />
				</td>
			</tr>
			<tr>
		...
		<input type="hidden" name="department_id" value="${departmentInformation.department_id }"/>
	</form>
</body>
</html>
