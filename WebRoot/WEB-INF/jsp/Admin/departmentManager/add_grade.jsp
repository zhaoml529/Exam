...
<html>
  ...
  <body>
	...
	<br />
	<form action="<c:url value='/department/saveGrade' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			...
			<tr>
				<td>机构名称</td>
				<td>
					<input type="text" name="grade_name"  emptyInfo="请填写机构名称"  size="40" />
				</td>
			</tr>
			<tr>
				<td>机构描述</td>
				<td>
					<input type="text" name="grade_remark" emptyInfo="请填写机构描述" size="40"/>
				</td>
			</tr>
			<tr>
