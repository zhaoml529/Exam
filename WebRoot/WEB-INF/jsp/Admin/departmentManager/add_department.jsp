...
<html>
  ...
  <body>
	...
	<br />
	<form action="<c:url value='/department/saveDepartment' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">添加机构</td>
			</tr>
			<tr>
				<td>机构名称</td>
				<td>
					<input type="text" name="department_name"  emptyInfo="请填写机构名称"  size="40" />
				</td>
			</tr>
			<tr>
				<td>机构描述</td>
				<td>
					<input type="text" name="department_remark" emptyInfo="请填写机构描述" size="40"/>
				</td>
			</tr>
			<tr>
