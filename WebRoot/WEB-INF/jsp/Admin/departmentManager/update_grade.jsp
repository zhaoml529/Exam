...
<html>
  ...
  <body>
	<table cellSpacing=0 cellPadding=5 style="" width="100%" border=0
		...
		<tr>
			<td class="manageHead">当前位置：修改年级</td>
		</tr>
		<tr>
			<td height=2></td>
		</tr>
	...
	<br />
	<form action="<c:url value='/department/updateGrade' />" method="post" onsubmit="return validateForm(this)">
		<table align="center" class="default">
			<tr class="title">
				<td colspan="2">修改年级</td>
			</tr>
			<tr>
				<td>年级名称</td>
				<td>
					<input type="text" name="grade_name" size="40" value="${gradeInformation.grade_name}" />
				</td>
			</tr>
			<tr>
				<td>年级描述</td>
				<td>
					<input type="text" name="grade_remark" size="40" value="${gradeInformation.grade_remark }" />
				</td>
			</tr>
			<tr>
		...
		<input type="hidden" name="grade_id" value="${gradeInformation.grade_id }"/>
	</form>
</body>
</html>
