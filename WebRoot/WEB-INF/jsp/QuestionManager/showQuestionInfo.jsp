...
<html>
  ...
  <body>
    ...
    <table class="default" width="1100px">
				...
				<tr><td>选择题编号</td><td>${choice.question_id }</td></tr>
				<tr><td>选择题题目</td><td>${choice.question_body }</td></tr>
				...
				<tr><td>正确答案</td><td>${choice.question_answer }</td></tr>
				<tr><td>试题难度</td><td>${choice.difficulty }</td></tr>
				<tr><td>所属科目</td><td>${choice.subject.subject_name }</td></tr>
				<tr><td>年级</td><td>${choice.grade.grade_name }</td></tr>
				<tr><td>添加人</td><td>${choice.add_person }</td></tr>
