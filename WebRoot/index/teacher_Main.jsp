...
border=0></TD></TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 height="93%">
			<TBODY>
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<table width="500" height="110" class="default" align="center">
							...
							<tr height="35">
								...
								<td align="center"><fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" /></td>
							</tr>
							<tr height="35">
								<td align="right" width="150">
									登录身份：
								</td>
								<td align="center">教师<%if(manage!=null){ %><a href="DoExitServlet?action=manage" target="_parent">[切换为管理员登录]</a><%}%></td>
							</tr>
							<tr height="10">
