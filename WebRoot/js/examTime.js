...
var scrolltotop={
	...
	controlHTML: '<div id="toolBackTo" class="back-to"><span class="back-top"></span></div>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
...
function loout(){ //////////////-----------
	$.ajax({
		...
		//$("div#rlink").html("<s:a href=\"enter\" cssClass=\"enter\">Login</s:a> | <a href=\"#\">Register</a>");
	    }
	});
}
function login()
{
	...
	if (username == "")
	{
	    $("#confirm").text("Must input ID.");
	    $("#username").focus();
	    return false;
	}
	if(password == "")
	{
	    $("#confirm").text("Must input password.");
	    $("#password").focus();
	    return false;
	}
	$.ajax({
	    ...
	    success: function(msg){
	        ...
	        $("#confirm").text("Username or password is invalid");
	    	}
	    }
	});
}
...
function s2(tb)
{
	...
	if(navigator.userAgent.indexOf("MSIE")>0) {   
		if (document.getElementById(tmp_u).style.display != "none") { 
			...
			document.getElementById(tmp_i).src='img/op.gif'; 
			document.getElementById(tmp_i).title="open it's comments"; 
		} 
		else{
			document.getElementById(tmp_u).style.display = ""; 
			document.getElementById(tmp_i).src='img/om.gif'; 
			document.getElementById(tmp_i).title="close it's comments"; 
		}
		return false;
   }   
	/* 
...
*/	 		//IEÏÂimgÊôÐÔÊ§Ð§
			if (document.getElementById(tmp_u).style.display != "none") { 
				$("#"+tmp_u).slideToggle("slow");
				document.getElementById(tmp_i).src='img/op.gif'; 
				document.getElementById(tmp_i).title="open it's comments"; 
				document.getElementById(tmp_i).alt="open it's comments"; 
			} 
			else{
				$("#"+tmp_u).slideToggle("slow");
				document.getElementById(tmp_u).style.display = ""; 
				document.getElementById(tmp_i).src='img/om.gif'; 
				document.getElementById(tmp_i).title="close it's comments"; 
				document.getElementById(tmp_i).alt="close it's comments"; 
			}
} 
