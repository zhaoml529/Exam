...
public class Comprehensive implements Serializable{
	...
	private String question_title;	//题目
	private String question_body;	//描述
	...
	/**
	 * @return the question_picture
	 */
	public String getQuestion_picture() {
		return question_picture;
	}
	/**
	 * @param questionPicture the question_picture to set
	 */
	public void setQuestion_picture(String questionPicture) {
